        ...
        <div class="col-md-4 my-5">
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <Field as="select" name="category" class="form-select form-select-solid">
          ...
          <div class="card shadow-sm px-1 my-6">
            <div class="card-body">
              ...
              <Field as="select" name="module" class="form-select form-select-solid">
        ...
        <div class="col-md-8">
          <div class="card shadow-sm">
            <div class="mb-4 px-4 py-4 col-11 mx-6">
              ...
              <Field name="productName" as="input" type="text" class="form-control" placeholder="Ponga el nombre del producto" />
              <ErrorMessage name="productName" class="text-danger" />
            </div>
            <div class="mb-4 px-4 py-4 col-11 mx-6">
              <label class="required form-label">Descripcion</label>
              <Field name="description" as="textarea" class="form-control" placeholder="Ponga la descripcion" />
            ...
            <div class="mb-4 px-4 py-3 col-11 mx-6">
              ...
              <Field name="lastName" as="input" type="text" class="form-control" placeholder="Ponga sus apellidos" />
              <ErrorMessage name="lastName" class="text-danger" />
            </div>
            <div class="mb-4 px-4 py-3 col-11 mx-6">
              <label class="required form-label">CI</label>
              <Field name="ci" as="input" type="text" class="form-control" placeholder="Ponga su CI" />
              <ErrorMessage name="ci" class="text-danger" />
            </div>
            <div class="mb-4 px-4 py-3 col-11 mx-6">
              <label class="required form-label">Correo</label>
              <Field name="email" as="input" type="email" class="form-control" placeholder="Ponga su correo" />
