<template>
  ...
  >
    <div class="card shadow-sm">
     ...
     <!-- Campo: ID de cuenta -->
     <div class="mb-4 px-4 py-4 col-11 mx-6">
        <label class="required form-label">ID de cuenta</label>
        <Field 
          name="idcuenta" 
          as="input" 
          type="text" 
        ...
        />
        <ErrorMessage name="idcuenta" class="text-danger" />
      </div>
...
import { defineComponent ,ref } from "vue";
  ...
  export default defineComponent({
    ...
    .required("El correo es obligatorio"),
      idcuenta: yup.string().required("El ID de cuenta es obligatorio"),
